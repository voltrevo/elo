...
module.exports = {
  ...
  rules: {
    ...
    'no-bitwise': 'off',
    'padded-blocks': 'off', // Noisy, but would be nice to still have the autofix
    // 'no-trailing-spaces': 'off', // Also noisy, but I need the autofix for this
    'no-use-before-define': 'off', // TypeScript is better at this than eslint
    'no-undef': 'off', // TypeScript is better at this than eslint
    'consistent-return': 'off', // TypeScript is better at this than eslint
    'no-redeclare': 'off', // TypeScript is better at this than eslint
    'no-loop-func': 'off',
    'no-undef-init': 'off', // Disagree, explicit is better... typescript features...
    'no-case-declarations': 'off',

    // These rules are great but the autofix is not helpful!
    'prefer-const': 'off',
    'no-autofix/prefer-const': 'warn',

    'arrow-body-style': 'off',
    'no-autofix/arrow-body-style': 'warn',
